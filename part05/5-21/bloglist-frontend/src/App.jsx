...
const App = () => {
  ...
  const addNewBlog = async (blogObject) => {
    ...
    try{
      ...
      const blogWithUser = {
        ...returnedBlog,
        user: user   // 👈 attach logged-in user immediately
      }
    ...
    <div>
      ...
      {user && (
        <div>
          ...
          {blogForm()}
          {[...blogs] // creates a shallow copy, does not keep blogs sorted automatically!!!
            .sort((a, b) => b.likes - a.likes) // only sort the copy, descending order
            .map(blog =>
              <Blog
                key={blog.id}
                blog={blog}
